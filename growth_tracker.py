...
class GrowthCalculator:
    ...
    def _initialize_comprehensive_cdc_data(self):
        ...
        return {
            'boys': {
                'weight_age': self._create_detailed_weight_data(ages, 'boys'),
                'height_age': self._create_detailed_height_data(ages, 'boys'),
                'head_age': self._create_detailed_head_data(ages, 'boys'),
                'bmi_age': self._create_detailed_bmi_data(ages, 'boys')
            },
            'girls': {
                'weight_age': self._create_detailed_weight_data(ages, 'girls'),
                'height_age': self._create_detailed_height_data(ages, 'girls'),
                'head_age': self._create_detailed_head_data(ages, 'girls'),
                'bmi_age': self._create_detailed_bmi_data(ages, 'girls')
            }
        }
...
def generate_all_charts(calculator):
    ...
    gender = st.session_state.patient_info.get('gender', 'boys')
...
def main():
    ...
    # Sidebar navigation - use query params for reliable navigation
    ...
    pages[selected_page](calculator, pdf_generator)
    ...
    with st.form("measurement_form", clear_on_submit=False):
        ...
        with col1:
            ...
            gender = st.selectbox("Gender *", ["boys", "girls"], 
                                index=0 if st.session_state.patient_info.get('gender') == 'boys' else 1)
